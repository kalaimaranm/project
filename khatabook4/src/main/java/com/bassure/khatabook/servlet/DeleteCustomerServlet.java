...
public class DeleteCustomerServlet extends HttpServlet {
    ...
    static KhatabookDAO khatabook = new MysqlKhatabookImplTest();
            ...
            case "confirmation": {
                try {
                    ...
                    if (khatabook.getCustomer().deleteCustomer(customer.getId())) {
                        out.print("<div bgcolor = 'green'><h1>Account deleted successfully...</h1>"
                                + "<br/><br/><br/><br/><br/><div align = \"center\">"
                                + "<button><a href = \"deletecustomer?option=home\">Home</a></button></div>");
//                        if (request.isUserInRole("CUSTOMER")) {
