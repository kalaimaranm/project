...
//                            out.print("<td> <button onclick=location.href=updateproduct?Id=" + tempProduct.getId() + ">Update Qty</button></td>");
...
//                    out.write("            //                var txt = document.getElementById(\"name\").defaultValue = \""+product.getId()+"\";\n");
//                    out.write("            //            }\n");
                    out.write("        </script>\n");
                    out.write("    </head>\n");
                    out.write("    <body>\n");
...
//                out.print("inside updateproductsubmit");
    ...
    public void deleteProductForm() {
        ...
        out.write("    <body>\n");
        out.write("\n");
        out.write("        <form name = \"deleteproduct\" action=\"product?option=deleteproduct\" method = \"post\">\n");
        ...
        out.write("                </div>\n");
        out.write("                <div class=\"formbuilder-button form-group field-submit\">\n");
