...
public interface CustomerDAO {
    ...
    public boolean payDebts(double amount, int id) throws SQLException, ClassNotFoundException;  // finally here you have to get how much amount for whom to pay
...
//    public boolean setCustomerBalance(int customerId, double amount) throws SQLException, ClassNotFoundException;
    public boolean updateCustomerBalance(int customerId, double balance) throws SQLException, ClassNotFoundException; // updateCustomerBalance()
